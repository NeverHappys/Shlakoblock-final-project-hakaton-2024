...
def main(page: ft.Page):
    ...
    def list_promt(): #база промптов для нейросети, которые составляются из частей
        start = ['Основная часть пищи готовится в протертом, жидком или кашеобразном виде, её варят в воде или на пару. Блюда можно запекать, но без корочки. Рыбу и негрубые сорта мяса можно подавать куском. Слишком холодные и очень горячие блюда из рациона исключают. ', 
                'Блюда этого стола в разной степени измельчённые и подвергшиеся тепловой обработке. Они могут быть отварными, тушёными, запечёнными и даже жареными. Также диета включает протёртые блюда. Для их приготовления используются продукты, насыщенные клетчаткой. ',
                'Это полноценное питание, которое состоит из блюд и продуктов, усиливающих двигательную активность кишечника, его способность к опорожнению. ',
                'Питание является максимально щадящим для кишок в механическом, химическом и термическом отношении. Пищу варят, готовят на пару, используют в пюреобразном или протёртом виде. ',
                'Диета обеспечивает полноценное питание, щадяще действуя на печень. В результате работа печени и желчных путей приходит в норму, улучшается желчеотделение. содержит оптимальное количество белков, жиров и углеводов. ',
                'Характерно значительное ограничение продуктов, в состав которых входят пурины, щавелевая кислота, также ограничение соли и обилие ощелачивающих продуктов, то есть овощей, фруктов, молока. Содержание белков и жиров должно быть ограничено.',
                'Характерная особенность – это ограниченное содержание в пище белков. При этом жиры и углеводы находятся в пределах физиологической нормы. Пищу готовят без соли. ',
        #не работает хз почему        'Диетическое питание отличается, прежде всего, низкой калорииностью пищи. в рационе значительно ограничивают углеводы, которые в организме человека быстро переходят в жир. Также ограничение распространяется на жиры животного происхождения, и предпочтение отдаётся растительным жирам. ',
                'Питание согласно столу – это рацион с ограничением, прежде всего, животных жиров и углеводов, при этом сохраняется физиологическая норма витаминов и минералов. Продукты и блюда, которые содержат много сахара, например, варенье или кондитерские изделия. ',
                'Характерная особенность этой диеты – это сокращение в рационе количества жиров и углеводов. Также значительно ограничивают количество поваренной соли, жидкости и продуктов, которые возбуждают сердечно-сосудистую и нервную системы. '
                ]
